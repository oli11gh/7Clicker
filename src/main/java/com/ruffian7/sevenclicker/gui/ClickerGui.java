...
public class ClickerGui {
	...
	private final int DROPDOWN_HEIGHT = 140;
	...
	public JLabel toggleKeyText = new JLabel("Toggle Bind");
	...
	public JCheckBox leftClickBox = new JCheckBox("Left Click", true);
	...
	private void setupSettings() {
		...
		overlayBox.setBounds(5, 163, 85, 16);
		...
		leftClickBox.setBounds(5, 180, 85, 16);
		leftClickBox.setBackground(LIGHT_GRAY);
		leftClickBox.setForeground(Color.WHITE);
		leftClickBox.setIcon(
				new ImageIcon(AutoClicker.class.getClassLoader().getResource("assets/checkbox_unchecked.png")));
		leftClickBox.setSelectedIcon(
				new ImageIcon(AutoClicker.class.getClassLoader().getResource("assets/checkbox_checked.png")));
		leftClickBox.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				AutoClicker.button = (leftClickBox.isSelected()) ? 2 : 1;
			}
		});
		mainPane.add(leftClickBox);

		rightClickBox.setBounds(5, 197, 85, 16);
		...
		rightClickBox.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				AutoClicker.button = (rightClickBox.isSelected()) ? 1 : 2;
			}
		});
		mainPane.add(rightClickBox);

		toggleKeyText.setBounds(11, 220, 66, 25);
		toggleKeyText.setForeground(Color.WHITE);
		mainPane.add(toggleKeyText);
		toggleKeyField.setBounds(WINDOW_WIDTH - 70, 222, 60, 20);
	...
	private void setupMisc() {
		try {
			...
			InputStream fontFile = AutoClicker.class.getClassLoader().getResourceAsStream("assets/BebasNeue.ttf");
			Font font = Font.createFont(Font.TRUETYPE_FONT, fontFile);
			ge.registerFont(font);
			fontFile.close();

			titleText.setFont(font.deriveFont(Font.PLAIN, 25));
			cpsNumber.setFont(font.deriveFont(Font.PLAIN, 60));
			cpsRange.setFont(font.deriveFont(Font.PLAIN, 13));
			overlayBox.setFont(font.deriveFont(Font.PLAIN, 12));
			rightClickBox.setFont(font.deriveFont(Font.PLAIN, 12));
			leftClickBox.setFont(font.deriveFont(Font.PLAIN, 12));
			toggleKeyText.setFont(font.deriveFont(Font.PLAIN, 12));
